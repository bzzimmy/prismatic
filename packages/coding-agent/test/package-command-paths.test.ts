...
// This fork disables upstream self-update (IS_OFFICIAL_DISTRIBUTION is false).
// Mock the official distribution so the upstream self-update machinery stays tested.
